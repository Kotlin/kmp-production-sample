...
### Native UI
​
The UI layer is fully native and implemented using SwiftUI for iOS, Jetpack Compose for Android and Compose Multiplatform for Desktop.
​
